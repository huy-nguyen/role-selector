(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.roleSelector = {}));
  ...
  function y(a){if("object"===typeof a&&null!==a){var t=a.$$typeof;switch(t){case b:switch(a=a.type,a){case d:case f:case e:case l:case m:return a;default:switch(a=a&&a.$$typeof,a){case h:case k$1:case p:case n:case g:return a;default:return t}}case c:return t}}}var z=g,A=b,B=k$1,C=d,D=p,E=n,F=c,G=f,H=e,I=l;reactIs_production_min.ContextConsumer=h;reactIs_production_min.ContextProvider=z;reactIs_production_min.Element=A;reactIs_production_min.ForwardRef=B;reactIs_production_min.Fragment=C;reactIs_production_min.Lazy=D;reactIs_production_min.Memo=E;reactIs_production_min.Portal=F;reactIs_production_min.Profiler=G;reactIs_production_min.StrictMode=H;
  ...
  reactIs_production_min.isPortal=function(a){return y(a)===c};reactIs_production_min.isProfiler=function(a){return y(a)===f};reactIs_production_min.isStrictMode=function(a){return y(a)===e};reactIs_production_min.isSuspense=function(a){return y(a)===l};reactIs_production_min.isValidElementType=function(a){return "string"===typeof a||"function"===typeof a||a===d||a===f||a===v||a===e||a===l||a===m||a===w||"object"===typeof a&&null!==a&&(a.$$typeof===p||a.$$typeof===n||a.$$typeof===g||a.$$typeof===h||a.$$typeof===k$1||a.$$typeof===u||a.$$typeof===q||a[0]===r)?!0:!1};
  ...
  var _AsymmetricMatcher = _interopRequireDefault$7(
    AsymmetricMatcher
  );
  ...
  var _ReactTestComponent = _interopRequireDefault$7(
    ReactTestComponent
  );
  ...
  */
  ...
  function parseSelector(selector) {
      ...
      const syntaxError = (stage) => {
          ...
          throw new Error(`Error while parsing selector \`${selector}\` - unexpected symbol "${next()}" at position ${wp}` +
              (stage ? ' during ' + stage : ''));
      };
      function skipSpaces() {
      ...
      function readIdentifier() {
          let result = '';
          skipSpaces();
          while (!EOL && /[a-zA-Z]/.test(next()))
              result += eat1();
          if (!result)
              syntaxError('parsing identifier');
          return result;
      }
      ...
      function readAttribute() {
          ...
          if (typeof value !== 'string' &&
              ...
              throw new Error(`Error while parsing selector \`${selector}\` - cannot use attribute ${name} with unsupported type ${typeof value} - ${value}`);
  ...
  function getValueText(element, role) {
      ...
      if (['grid', 'listbox', 'tablist', 'tree', 'combobox'].includes(role)) {
          ...
          const selectedOptions = ['gridcell', 'option', 'row', 'tab'].flatMap((role) => queryAllByRoleWithSuggestions(element, role, {
              selected: true,
          }));
  ...
  function queryAll$1(root, selector) {
      const { role, attributes } = parseSelector(selector);
      ...
      let elements = queryAllByRoleWithSuggestions(rootElement, role, options);
  ...
  function query$1(root, selector) {
      return queryAll$1(root, selector)[0] || null;
  }
  var roleSelector = {
      query: query$1,
      queryAll: queryAll$1,
  ...
  function stringify(json, space) {
      return JSON.stringify(json, (_key, value) => (value instanceof RegExp ? value.toString() : value), space);
  }
  function suggestSelector(element, options = {}) {
      ...
      if (suggestedQuery) {
          ...
          const checkSelector = (selector) => {
              const selectedElements = roleSelector.queryAll(element.ownerDocument.documentElement, selector);
              if (!selectedElements.length)
                  return false;
              else if (strict && selectedElements.length > 1)
                  return false;
...
${stringify({ role, ...attributes }, 2)}`);
  ...
  const query = roleSelector.query;
  const queryAll = roleSelector.queryAll;
  ...
  const screen = typeof document !== 'undefined' && within(document.body);
